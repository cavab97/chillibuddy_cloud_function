...
import { routeTicket as object } from "../../z-tools/system/objectsConfig";
...
export default functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    //Data Processing
    const objectData = object.attributes(data).verifyObjectState;
    ...
    return httpUtils.successResponse({
      ...
      ids: [objectId],
      action: event,
      message: `Verify ${objectName} successfully.`,
    });
  } catch (error) {
