...
import { reward as object } from "../../z-tools/system/objectsConfig";
...
export default functions.https.onCall(async (data, context) => {
  try {
    ...
    //Data Processing
    const objectData = object.attributes(claimData).claimObjectState;
    ...
    return httpUtils.successResponse({
      ...
      ids: [objectId],
      action: event,
      message: `Claim ${objectName} successfully.`,
    });
  } catch (error) {
